...
XPSS
                                 A QGIS plugin
 This plugin performs pressure sewer calculations within QGIS.
                              -------------------
        begin                : 2021-07-21
        git sha              : $Format:%H$
        copyright            :
...
from .ui.xpss_dockwidget import XPSSDockWidget, MyQFileDialog
import os.path
...
class XPSS(object):
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&XPSS')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'XPSS')
        self.toolbar.setObjectName(u'XPSS')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('XPSS', message)
    ...
    def run(self):
        ...
        if self.dockwidget is None:
            ...
            self.dockwidget = XPSSDockWidget(self.iface, self.params, config)
